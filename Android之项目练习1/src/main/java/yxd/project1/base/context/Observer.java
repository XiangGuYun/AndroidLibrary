...
public class Observer {
    ...
    public static Message activityMessage, fragmentMessage;
    ...
    public void notifySome(Message message, ActivitySubject...subjects){
        this.activityMessage = message;
    ...
    public void notifySome(Message message, FragmentSubject...subjects){
     ...
     * 添加一个Activity订阅者
     */
    public void add(ActivitySubject subject){
    ...
    public void add(FragmentSubject subject){
        if(!fragmentSubs.contains(subject)) fragmentSubs.add(subject);
    }

    public void addList(List<FragmentSubject> subjects){
        for (FragmentSubject sub: subjects) {
            if(!fragmentSubs.contains(sub)) fragmentSubs.add(sub);
        }
    }
